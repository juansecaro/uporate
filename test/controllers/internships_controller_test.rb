...
class InternshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create internship" do
    assert_difference('Internship.count') do
      post internships_url, params: { internship: { averagemark: @internship.averagemark, company_id: @internship.company_id, details: @internship.details, status: @internship.status, title: @internship.title } }
    end
  ...
  test "should update internship" do
    patch internship_url(@internship), params: { internship: { averagemark: @internship.averagemark, company_id: @internship.company_id, details: @internship.details, status: @internship.status, title: @internship.title } }
